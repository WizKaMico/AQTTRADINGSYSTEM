 <section class="section-slide">
		 <iframe src="ADMIN/homeslider/" style="width:100%; height: 1000px; border:none; overflow: hidden; margin-top:50px; margin-bottom:-150px;" scroll="no"></iframe> 
	</section> 
			...
			<div class="row isotope-grid">
			    ...
			    if (! empty($product_array)) {
			        foreach ($product_array as $key => $value) {
                        ...
                        $remaining_stock =   $product_array[$key]["qty"] - $p_quantity['total'];
			     ?>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item <?php echo $product_array[$key]["category"]; ?>">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="ADMIN/pages/FRAME/<?php echo $product_array[$key]["photo"];  ?>" alt="IMG-PRODUCT" style="width:50%; height:200px;">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="login.php?view=<?php ECHO 'NOTSPECIFIC'; ?>&code=<?php echo $product_array[$key]["code"]; ?>" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
