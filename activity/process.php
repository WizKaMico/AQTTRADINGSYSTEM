						...
						<div class="flex-w flex-t bor12 p-t-15 p-b-30">
							...
							<div class="size-209 p-r-18 p-r-0-sm w-full-ssm">
								...
								<div class="bor8 bg0 m-b-12">
									<input type="text" class="stext-111 cl8 plh3 size-111 p-lr-15" name="name" id="name" value="<?php echo $row['name']; ?>" required="" readonly="">
								</div>	

								<div class="bor8 bg0 m-b-12">
									<input type="text" class="stext-111 cl8 plh3 size-111 p-lr-15" name="email" id="email"  value="<?php echo $row['email']; ?>" required="" readonly="">
									<input type="hidden" class="stext-111 cl8 plh3 size-111 p-lr-15" name="code" id="email" value="<?php echo rand(66666,99999); ?>" required>
								</div>	
								<div class="bor8 bg0 m-b-12">	
							...
							</div><?php $houseloc =  $row['address'].','.$row['city'].','.$row['province'];  ?>

								<iframe src="ADMIN/pages/FRAME/map/?houseloc=<?php echo $houseloc;  ?>" style="width:100%; border:none; height:600px;"></iframe>	
						</div>
