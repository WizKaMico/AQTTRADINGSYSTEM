...
$crow=mysqli_fetch_array($coderes);
              ...
              $remaining_stock =   $crow["qty"] - $p_quantity['total'];
					...
					<div class="p-l-25 p-r-30 p-lr-0-lg">
						<div class="wrap-slick3 flex-sb flex-w">
							...
							<div class="slick3 gallery-lb">
								<div class="item-slick3" data-thumb="ADMIN/pages/FRAME/<?php echo $crow["photo"]; ?>">
									<div class="wrap-pic-w pos-relative">
										<img src="ADMIN/pages/FRAME/<?php echo $crow["photo"]; ?>" alt="IMG-PRODUCT">
						 ...
						 <form method="post" action="index.php?action=add&code=<?php echo $crow['code']; ?>&view=<?php echo 'SPECIFIC'; ?>">
							<div class="flex-w flex-r-m p-b-10">
								<div class="size-204 flex-w flex-m respon6-next">
									<a href="login.php?view=HOME" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04 js-addcart-detail">
