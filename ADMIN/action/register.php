...
if(isset($_POST['register'])){
        ...
        if($captcha_code == $captcha_input){ 		
          ...
          mysqli_query($conn,"INSERT INTO users (fullname, email, password, code) VALUES ('$fullname', '$email', '$password', '$code')");  

         

 require 'mailler/autoload.php';
    
      $subject = 'AQT MANAGEMENT | EMAL VERIFICATION : '.strtoupper($email).' ';
...
<head>
  <meta charset="UTF-8">
  <title>AQT MANAGEMENT | EMAL VERIFICATION </title>
                ...
                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td>
                      ...
                      <p>WELCOME AQT MANAGEMENT | EMAL CONFIRMATION CODE</p><br>
