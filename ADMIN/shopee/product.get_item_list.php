...
$api_path = '/api/v2/product/get_item_list'; //shopee API path
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://partner.test-stable.shopeemobile.com/api/v2/product/get_item_list?access_token='.$access_token.'&item_status=%5B%22NORMAL%22%5D&offset=0&page_size=10&partner_id=1009753&shop_id='.$shop_id.'&sign='.$sign.'&timestamp='.$timestamp.'&update_time_from='.$dayBeforeYesterday.'&update_time_to='.$timestamp.'',
