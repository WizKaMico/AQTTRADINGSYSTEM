...
$member_id = 8; // you can your integerate authentication module here to get logged in member
...
?>
          ...
          <div class="menu-desktop">
            <ul class="main-menu">
              <li class="active-menu">
                <a href="login.php?view=<?php echo 'HOME'; ?>">Home</a>
              </li>
  ...
  <?php include('activity/nothome.php'); ?>
  ...
  <?php include('activity/login.php'); ?>
  <?php } else if($_GET['view'] == 'REGISTER'){ ?>
  <?php include('activity/register.php'); ?>
  <?php } else if($_GET['view'] == 'NOTSPECIFIC'){ ?>
  <?php include('activity/notspecific.php'); ?>
  <?php } else if($_GET['view'] == 'CONFIRMATION'){ ?>
  <?php include('activity/confirmation.php'); ?>
   <?php } else if($_GET['view'] == 'FORGOT'){ ?>
  <?php include('activity/forgot.php'); ?>
  <?php } else if($_GET['view'] == 'CHANGEPASS'){ ?>
  <?php include('activity/changepass.php'); ?>
